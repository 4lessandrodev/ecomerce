...
class CategoriaCestasModel {
     ...
     salvarCategoriaCesta(categoria) {
      ...
      INSERT INTO tb_categoria_cestas(descricao, status, categoria_c_excluida) VALUES(?,?,?)
        `,
                    [
                         categoria._descricao,
                         categoria._status,
                         categoria._categoria_c_excluida,
                    ],
                    (err, result) => {
                         if (err) {
     ...
     listarCategoriaCestasAtivas(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `SELECT * FROM tb_categoria_cestas WHERE categoria_c_excluida = ? AND status = ?`,
                    [categoria._categoria_c_excluida, categoria._status],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
                              reject(err.message);
     ...
     listarTodasCategoriaCestas(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `SELECT * FROM tb_categoria_cestas WHERE categoria_c_excluida = ?`,
                    [categoria._categoria_c_excluida],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
     ...
     atualizarCategoriaCesta(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `UPDATE tb_categoria_cestas SET descricao = ?, status = ?, categoria_c_excluida = ? WHERE id =?`,
                    [
                         categoria._descricao,
                         categoria._status,
                         categoria._categoria_c_excluida,
     ...
     desabilitarCategoriaCesta(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `UPDATE tb_categoria_cestas SET categoria_c_excluida = ? WHERE id =?`,
                    [categoria._categoria_c_excluida, categoria._id],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
                              reject(err.message);
