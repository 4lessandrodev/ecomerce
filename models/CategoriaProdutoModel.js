...
class CategoriaProdutoModel {
    ...
    `,
                    [
                         ...
                         categoria._status,
                         categoria._categoria_p_excluida,
                    ],
                    (err, result) => {
                         if (err) {
    ...
    `,
     ...
     listarCategoriasAtivas(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `SELECT * FROM tb_categoria_produtos WHERE categoria_p_excluida = ? AND status = ?`,
                    [categoria._categoria_p_excluida, categoria._status],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
                              reject(err.message);
     ...
     listarTodasCategorias(categoria) {
          return new Promise((resolve, reject) => {
               conect.query(
                    `SELECT * FROM tb_categoria_produtos WHERE categoria_p_excluida = ?`,
                    [categoria._categoria_p_excluida],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
    ...
    `,
                    [categoria._categoria_p_excluida, categoria._id],
                    (err, result) => {
                         if (err) {
                              console.log(err.message);
                              reject(err.message);
