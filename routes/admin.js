...
router.get('/', (req, res, next) => {
     adminController.autenticar(req, res, next)
...
router.get('/mensagem', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? contatoController.listarMensagens(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Excluir um email
router.delete('/deletar-email', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? contatoController.excluirMensagem(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/status-produtos', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.editarStatusProdutos(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Editar status dos produtos
router.put('/produto-alterar-status', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.alterarStatusProdutos(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Editar uma produtos
...
router.put('/produto-alterar-estoque', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.ajustarEstoque(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.put('/zerar-estoque', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.zerarEstoque(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/status-cestas', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? cestaController.alterarStatusCestas(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/limpar-cesta', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoParaCestaController.limparProdutosDaCesta(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.get(
     '/pedido/:status_pedido?/:data_inicial?/:data_final?/:numero_pedido?',
     (req, res, next) => {
          adminController.autenticar(req, res, next)
               ? pedidoController.listarPedidos(req, res, next)
               : '';
...
router.get('/pedido-selecionado/:id', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? pedidoController.listarPedidoEspecificoAdmin(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/status-pedido/:id/:status', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? pedidoController.alterarStatusPedido(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/status-pedidos', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? pedidoController.alterarStatusPedidos(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.get('/estoque', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.listarTodosProdutosEstoque(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//lançar estoque
router.post('/estoque', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? produtoController.lancarEstoque(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.get('/planos', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? planoController.paginaPlanos(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Planos de assinatura
router.post('/planos', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? planoController.salvarPacotePlano(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.delete('/plano', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? planoController.deletarPlano(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.get('/relatorio-entregas', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.relatorioEntregas(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Relatorio entregas
router.get('/relatorio-produtos', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.relatorioPedidos(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
//Relatorio entregas
router.get('/relatorio-assinantes', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.relatorioAssinantes(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.get('/assinatura-selecionada/:id', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.assinaturaSelecionada(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/cesta-entregue', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.lancarCestaEntregue(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
...
router.post('/status-plano', (req, res, next) => {
     adminController.autenticar(req, res, next)
          ? adminController.alterarStatusPlano(req, res, next)
          : '';
});
//------------------------------------------------------------------------------------------------------
